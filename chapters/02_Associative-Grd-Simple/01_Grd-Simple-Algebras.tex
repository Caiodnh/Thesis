...
\begin{defi}
    Let $R\neq 0$ be an associative superalgebra. 
    If $R \iso M(m,n)$, for some $m,n \in \ZZ_{\geq 0}$, we say that $R$ is of type $M$. 
    If $R \iso Q(n)$, for some $n \in \ZZ_{\geq 0}$, we say that $R$ is of type $Q$. 
\end{defi}