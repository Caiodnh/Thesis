\section{Gradings on superinvolution-simple superalgebras of type \texorpdfstring{$M$}{M}}
...
\begin{proof}
    Follows from \cref{prop:R-simple-iff-D-simple,cor:sinv-implies-type-M}. 
\end{proof}
