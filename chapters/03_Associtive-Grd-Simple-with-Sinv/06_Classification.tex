...
\Cref{prop:superpolarization} gives a strong restriction if $\D$ simple as a superalgebra. 
...
\begin{cor}\label{cor:sinv-implies-type-M}
    If $\D$ is simple as a superalgebra and admits a superinvolution, then $\D$ is even and of type $M$.
\end{cor}
