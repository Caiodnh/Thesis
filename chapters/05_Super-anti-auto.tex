...
\begin{defi}
    Let $(\D, \vphi_0)$ and $(\D', \vphi_0')$ be graded-division superalgebras with super-anti-automorphisms and let $\psi_0 \from (\D, \vphi_0) \to (\D', \vphi_0')$ be a degree preserving homomorphism. 
    Given a $\D'$-supermodule $\U$ and
\end{defi}
