\section{Super-anti-automorphisms and \texorpdfstring{ses\-qui\-li\-near\\}{sequilinear} forms}\label{sec:super-anti-auto-and-sesquilinear}
...
To state the theorem, recall \cref{def:superinner}.
