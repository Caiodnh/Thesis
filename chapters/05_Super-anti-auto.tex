...
\begin{lemma}
    Given a triple $(g_0, \delta, \kappa) \in \mathsf{X}(\D, \vphi_0)$, there are a graded $\D$-module $\U$ of finite rank and a $\vphi_0$-sesquilinear form $B$ on $\U$ such that $\overline{B} = \delta B$.
\end{lemma}
