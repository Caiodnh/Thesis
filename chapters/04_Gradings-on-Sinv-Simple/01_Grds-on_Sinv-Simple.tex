...
% As a corollary, we classify the finite dimensional superinvolution-simple superalgebras over $\FF$. 

% Note that \cref{lemma:sinv-type-M} implies, in the case $G$ is trivial, that superalgebras of type $Q$ do not admit superinvolutions (\cite{Sh98}). 
...
The isomorphism classes of the double types are parametrized only by $m$ and $n$. 
