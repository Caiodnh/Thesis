...
\begin{remark}
    One can easily see that the $\barr G$-grading on $S$ above is isomorphic to $\Gamma_Q(\barr {T^+}, \barr {\beta^+}, \bar h, \kappa)$ (see \cref{def:Gamma-T-beta-kappa-Q}) by using the choices (i) $\barr \D \coloneqq \barr \D\even \oplus u\barr\D\even$ and (ii) $\barr \gamma$ as above. 
    ...
    The construction above corresponds directly to the case where $\Gamma$ is of Type II there. 
\end{remark}
...
\begin{proof}
    ...
    By definition, $\eta\restriction_{K} = \mu_K$ and it is clear that $\eta\restriction_{\langle f \rangle} = \chi\inv\restriction_{\langle f \rangle}$. % @1
