\section[Gradings on superinvolution-simple superalgebras of type \texorpdfstring{$M$}{M}]{Gradings on superinvolution-simple \\ superalgebras of type $M$}\label{sec:vphi-grds-on-type-M}
