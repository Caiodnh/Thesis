...
\begin{proof}
    The result follows from \cref{prop:Q-Type-II-correspondence,thm:QxQ-type-I,cor:QxQ-reduced-to-MxM}. 
    
    % Let $S$ denote the the the associative superalgebra $Q(n+1)$. 
