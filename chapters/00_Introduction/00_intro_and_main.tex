...
Another realization of $Q(n)$ is as $R\even \oplus u\, R\even$, where $R\even \coloneqq M_n(\FF)$ and $u$ is an odd variable commuting with all elements in $R\even$ such that $u^2 = 1$. 
...
Lie superalgebras of Cartan Type are also not considered in this work, but we give here their definitions for completeness.
...
Also cite \cite{MR3886336} and \cite{Felipe_Yuri_SPJournal} around here.
