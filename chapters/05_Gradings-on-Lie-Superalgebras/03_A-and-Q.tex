...
\[\label{eq:theta-with-matrix-5}
    \forall X\in Q_{n+1}(\FF), \quad \theta(X) = \Theta\inv\, X\stransp\, \Theta,
\]
where 
\[
...
% @1
SHOULD WE SIMPLY PUT A REFERENCE INSTEAD THIS LAST EQUATION?

THE NEXT DEFINITION AND PROPOSITION ARE WITH THE OLD CONSTRUCTION STILL.
