...
\begin{lemma}
    ...
    Set $R = \End_\D(\U)$ and, as done in Section \cref{}, identify $R\even$ with $\End_{\D\even} (\U\even)$. 
    If $\vphi\from R \to R$ is the superadjunction with respect to $B$ (Def.), then $\vphi\restriction_{R\even}\from R\even \to R\even$ is the superadjunction with respect to $B\restriction_{\U\even \times \U\even} \from \U\even \times \U\even \to \D\even$. \qed
\end{lemma}
